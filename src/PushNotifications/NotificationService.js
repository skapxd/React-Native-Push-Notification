...
export class NotificationService {
  /**
   * @param {import('./types').onRegister} onRegister
   * @param {import('./types').onNotification} onNotification
   */
   ...
   */
  createRemoteNotification(deviceToken, serverToken) {
    console.log(
      '🚀 ~ file: NotificationService.js ~ line 193 ~ NotificationService ~ createRemoteNotification ~ serverToken',
      serverToken,
    );
    console.log(
      '🚀 ~ file: NotificationService.js ~ line 193 ~ NotificationService ~ createRemoteNotification ~ deviceToken',
      deviceToken,
    );
    const myHeaders = new Headers();
    myHeaders.append('Authorization', `key=${serverToken}`);
